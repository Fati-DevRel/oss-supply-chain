...
**Capslock**[^capslock] is a specialized static analysis tool from Google for Go packages that focuses on analyzing capabilities—the privileged operations a package can perform.

- **Strengths**: Go-specific, capability analysis, supply chain focused
- **Model**: Analyzes what packages *can do* (files, network, exec) vs. traditional vulnerability scanning
- **Deployment**: CLI tool

```shell
# Analyze capabilities of a Go package
capslock -packages=github.com/user/package

# Output shows capabilities like:
# - FILES: filesystem access
# - NETWORK: network connections  
# - EXEC: executing programs
# - RUNTIME: Go runtime modifications
```
...
| Feature | Semgrep | CodeQL | SonarQube | Capslock |
|---------|---------|--------|-----------|----------|
| Speed | Fast | Slow (build DB) | Medium | Fast |
| Custom rules | Easy (YAML) | Moderate (QL) | Complex | N/A |
| Data flow | Limited | Excellent | Good | N/A |
| Languages | 30+ | 10+ | 25+ | Go only |
| False positives | Low | Low-Medium | Medium | Very Low |
| Cost | Free (OSS) | Free (public), paid (private) | Free tier, commercial | Free (OSS) |
| Focus | General SAST | General SAST | General SAST | Capabilities |
...
[^capslock]: Google, "Capslock: What is your code really capable of?" September 2023, https://security.googleblog.com/2023/09/capslock-what-is-your-code-really.html and https://github.com/google/capslock
