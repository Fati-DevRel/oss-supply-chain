...
!!! danger "100:1 NHI Ratio"

    Non-human identities (service accounts, tokens, API keys) outnumber human identities by 100:1 or more in enterprise environments. Audits commonly find hundreds of undocumented service accounts, many unused for years yet retaining production access.
