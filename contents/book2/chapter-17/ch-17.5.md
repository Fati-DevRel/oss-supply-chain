...
description: "Creating unforgeable records of build origins using in-toto framework and SLSA provenance for supply chain verification."
icon: "lucide/stamp"
---
...
!!! info "Answer: Which Apps Contain Log4j?"
    ...
    During Log4Shell, organizations that lacked provenance couldn't answer which deployed apps contained Log4j. Provenance creates an unforgeable record of how software was built—sources, dependencies, toolchain, process—enabling verification previously impossible.
