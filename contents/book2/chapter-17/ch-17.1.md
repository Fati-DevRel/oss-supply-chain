...
The [OWASP CI/CD Security Top 10](https://owasp.org/www-project-top-10-ci-cd-security-risks/) identifies the most critical risks:
...
[SLSA](https://slsa.dev/) (Supply-chain Levels for Software Artifacts) defines provenance requirements:
