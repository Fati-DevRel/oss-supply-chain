---
title: "Developer Workstation Security"
description: "Secure developer machines as software factories—compromising them means compromising everything those developers produce."
icon: "lucide/laptop"
---

# 16.1 Developer Workstation Security

!!! danger "Developer Laptops Are Software Factories"

    XcodeGhost (2015) targeted developer machines, not Apple's servers. Developers unknowingly compiled malware into their apps, infecting millions. A compromised developer provides access to push code, trigger builds, and deploy to production.
...
!!! tip "Balance Protection with Performance"

    Exclude build outputs (`node_modules`, `target/`, `build/`) from real-time scanning. Use process-based exclusions for verified build tools. Monitor credential theft, process injection, and unusual network activity.
