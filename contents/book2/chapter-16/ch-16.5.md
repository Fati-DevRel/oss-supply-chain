...
Research on how developers choose dependencies—including studies by Wermke et al. on npm package selection[^wermke-2022]—has found that security consistently ranks below convenience, documentation quality, and familiarity. Security is typically the third-rated consideration when selecting a library, after functionality and ease of use. This isn't because developers don't care about security—it's because human cognition prioritizes immediate needs over abstract future risks. Understanding developer psychology is essential for designing systems that produce secure outcomes, not by fighting human nature but by working with it.
