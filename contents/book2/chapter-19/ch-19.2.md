...
If you operate a private package repository ([Artifactory](https://jfrog.com/artifactory/), [Nexus](https://www.sonatype.com/products/nexus-repository), [Verdaccio](https://verdaccio.org/)), block the compromised package from being served:
