...
3. **Check signatures and provenance**: If the package supports Sigstore[^sigstore] or other signing, verify signatures come from expected identities:
...
1. **Dependency update automation**: Tools like Dependabot[^dependabot] and Renovate[^renovate] can create pull requests across multiple repositories simultaneously. Configure them to prioritize the compromised package:
