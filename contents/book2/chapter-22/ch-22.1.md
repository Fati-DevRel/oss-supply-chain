...
The [2023 State of DevOps Report](https://www.puppet.com/resources/state-of-devops-report) from Puppet found that 94% of respondents agreed that platform engineering is helping their organizations better realize the benefits of DevOps, with 68% reporting sharp increases in development velocity from dedicated platform teams. Gartner predicts that [80% of large software engineering organizations will establish platform teams by 2026](https://www.gartner.com/en/infrastructure-and-it-operations-leaders/topics/platform-engineering), up from 45% in 2022.

Leading technology companies pioneered platform approaches:

- **Spotify** developed [Backstage](https://backstage.io/), an open source developer portal that has become a foundation for many internal developer platforms
- **Netflix** built sophisticated internal platforms enabling rapid deployment at massive scale. Their ["Paved Road" approach](https://netflixtechblog.medium.com/scaling-appsec-at-netflix-6a13d7ab6043) to security has been widely influential
...
[**Humanitec**](https://humanitec.com/) and similar Internal Developer Platform (IDP) vendors build security capabilities into their platforms, enabling organizations to define security policies that are enforced automatically as developers deploy applications.
