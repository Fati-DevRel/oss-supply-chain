...
**[Amazon Q Developer](https://docs.aws.amazon.com/amazonq/)** (formerly CodeWhisperer):
...
- [Devin](https://www.cognition.ai/blog/introducing-devin) (Cognition AI): Autonomous software engineering agent
- [GitHub Copilot Workspace](https://github.blog/news-insights/product-news/github-copilot-workspace/): Task-level code generation and modification
- [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)-style frameworks: Self-directed goal pursuit
...
[pickle-exploit-tob]: https://blog.trailofbits.com/2024/06/11/exploiting-ml-models-with-pickle-file-attacks-part-1/
