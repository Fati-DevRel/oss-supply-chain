...
Traditional FIM tools like **[OSSEC](https://www.ossec.net/)**, **[AIDE](https://aide.github.io/)**, and **[Tripwire](https://github.com/Tripwire/tripwire-open-source)** periodically scan filesystems, compute cryptographic hashes, and alert on differences from baseline:
...
Commercial RASP solutions from vendors like **[Contrast Security](https://www.contrastsecurity.com/)**, **[Imperva](https://www.imperva.com/)**, and **[Dynatrace](https://www.dynatrace.com/)** integrate with Java, .NET, Node.js, and other runtimes. Open source options include:

- **[OpenRASP](https://github.com/baidu/openrasp)** (Baidu): Supports Java and PHP with plugin architecture
- **Sqreen** (acquired by Datadog in 2021, now integrated into **[Datadog Application Security Monitoring](https://www.datadoghq.com/product/application-security-monitoring/)**)
...
**[Falco](https://falco.org/)** (CNCF graduated project, maintained by Sysdig) focuses on threat detection through customizable rules:
...
**[Tetragon](https://tetragon.io/)** (Cilium project, maintained by Isovalent) provides both detection and enforcement capabilities:
...
**[Cilium](https://cilium.io/)** provides network-layer security using eBPF, enforcing network policies and providing visibility into service-to-service communication:
...
Tools like **[Sysdig Secure](https://sysdig.com/products/secure/)**, **[Lacework](https://www.lacework.com/)**, and **[Aqua Runtime Protection](https://www.aquasec.com/)** build behavioral models from observed activity, alerting on deviations. Open source options include using Falco with learning mode to generate rules based on observed behavior.
