...
!!! warning "Communication Failures Compound Incidents"
    ...
    Okta's initial Lapsus$ communications denied breach, then minimized scope. As details emerged, trust eroded—not because of the breach itself, but because of perceived communication failures. Cloudflare's transparent, detailed blog post provided notable contrast.

External communication during a supply chain incident determines how customers, partners, and the public perceive your organization's security posture and integrity. When Okta disclosed the Lapsus$ breach[^okta-lapsus-statement] in March 2022, their initial communications first denied any breach, then minimized the incident's scope to "a small percentage" of customers. As additional details emerged revealing broader impact, customer trust eroded—not because of the breach itself, but because of perceived communication failures. Conversely, when Cloudflare disclosed their Okta exposure with a transparent, detailed blog post[^cloudflare-okta-investigation], their proactive communication provided a notable contrast to Okta's approach.
...
|------------|-------|----------------------|-----------|
| GDPR[^gdpr-breach-notification] | EU resident data | 72 hours to authority | Data Protection Authority |
| CCPA/CPRA[^ccpa] | California resident data | "Expedient" | Affected individuals |
| HIPAA[^hipaa-breach] | Protected health information | 60 days | Individuals; HHS for 500+ |
| GLBA | Financial institution data | As soon as possible | Federal regulator |
| NIS2[^nis2-article-23] | Critical infrastructure (EU) | 24 hours initial, 72 hours full | CSIRT |
| SEC (8-K)[^sec-cyber-disclosure] | Material incidents (public companies) | 4 business days | SEC, public filing |
...
[^ccpa]: California Attorney General, "California Consumer Privacy Act (CCPA)," https://oag.ca.gov/privacy/ccpa
