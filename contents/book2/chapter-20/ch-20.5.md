---
title: "Release Notes and Changelog Security"
description: "Balance disclosure detail with exploitation risk in release notes—graduated disclosure gives defenders time before revealing details."
icon: "lucide/scroll-text"
---

# 20.5 Release Notes and Changelog Security

!!! warning "Balance Transparency with Exploitation Risk"

    Detailed vulnerability documentation helps defenders but also helps attackers. Too vague, users may not recognize urgency. Too detailed, you hand attackers a roadmap. Consider graduated disclosure: minimal detail initially, full details after adoption window.
...
!!! tip "Graduated Disclosure Timeline"

    1) **Initial release**: Minimal detail—severity, affected versions, upgrade recommendation. 2) **After 2-4 weeks**: Moderate detail—vulnerability class, attack vector. 3) **After 90 days**: Full technical details.
