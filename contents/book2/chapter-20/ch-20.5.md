...
A well-maintained **changelog** provides a chronological record of notable changes, enabling users to understand the evolution of a project and make informed upgrade decisions. The [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) specification provides a widely-adopted format.
...
[Semantic versioning (SemVer)](https://semver.org/) conventions for security fixes:
...
This approach, used by major projects like [OpenSSL](https://www.openssl.org/blog/blog/2020/05/12/security-prenotifications/) and [Kubernetes](https://github.com/kubernetes/committee-security-response/blob/main/security-release-process.md), allows organizations to prepare for updates without revealing exploitable details to attackers.

#### Recommendations

We recommend the following practices for security release documentation:

1. **Maintain a changelog**: Use a consistent format that clearly identifies security-relevant changes. The [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) specification provides an excellent foundation.
