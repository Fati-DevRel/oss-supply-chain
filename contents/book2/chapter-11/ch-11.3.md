...
The OpenSSF Security Insights specification[^security-insights-spec] provides a standardized, machine-readable way for projects to communicate their support model. Check for `SECURITY-INSIGHTS.yml` in the repository root or `.github/` directory.
...
project-lifecycle:
  ...
  roadmap-url: "https://github.com/USERNAME/REPO/blob/main/roadmap"
...
[^osps-baseline]: OpenSSF Alpha-Omega, "OSPS Baseline Scanner," https://github.com/ossf/alpha-omega/tree/main/alpha/baseline-scan
