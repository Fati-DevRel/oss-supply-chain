...
- [**left-pad (2016)**](https://en.wikipedia.org/wiki/Npm_left-pad_incident): 11-line package removed from npm on March 22, 2016, broke thousands of builds for 2.5 hours because it was depended upon transitively by many packages
- [**event-stream (2018)**](https://blog.npmjs.org/post/180565383195/details-about-the-event-stream-incident): Popular package with high fan-in was compromised in November 2018, affecting packages throughout npm and targeting Bitcoin wallets
- [**colors.js (2022)**](https://www.sonatype.com/blog/npm-libraries-colors-and-faker-sabotaged-in-protest-by-their-maintainer-what-to-do-now): Sabotage on January 8, 2022 affected thousands of packages that depended on it
...
[**OpenSSF Scorecard**](https://scorecard.dev/) automates many of these assessments:
...
**Commercial Tools:**
- [Snyk](https://snyk.io/): Dependency trees with vulnerability overlay
- [Sonatype Nexus Lifecycle](https://www.sonatype.com/products/open-source-security-dependency-management): Interactive dependency analysis
- [JFrog Xray](https://jfrog.com/xray/): Universal dependency scanning with visualization
