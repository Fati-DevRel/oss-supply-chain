...
- NuGet (.NET) projects typically have **6-10 direct dependencies** that expand to **20-70 transitive dependencies**, with [NuGet being the most widely used package managers in the .NET ecosystem][nuget-stats]
