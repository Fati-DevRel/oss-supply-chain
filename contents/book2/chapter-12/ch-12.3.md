...
- **FDA AI/ML guidance**[^fda-aiml]: Medical device AI documentation (enforceable since October 2023)
- **NIST AI RMF**[^nist-ai-rmf]: Risk management framework
- **China AI regulations**: Algorithm registration requirements

[^fda-aiml]: FDA, "Artificial Intelligence and Machine Learning (AI/ML)-Enabled Medical Devices," https://www.fda.gov/medical-devices/software-medical-device-samd/artificial-intelligence-and-machine-learning-aiml-enabled-medical-devices
