...
!!! tip "Base Scenarios on Real Attacks"
    ...
    Design exercises around observed attacks: compromised developer credentials (Codecov), CI/CD exploitation (SolarWinds), artifact poisoning, and upstream dependency compromise (event-stream). Test detection capabilities, not just vulnerabilities.
