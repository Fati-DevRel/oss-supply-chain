...
Technology companies with strong platform engineering functions often adopt this model. [Google's approach](https://cloud.google.com/security/solutions/software-supply-chain-security), where security is embedded in the developer platform rather than imposed externally, exemplifies this.
...
[Microsoft's approach](https://devblogs.microsoft.com/engineering-at-microsoft/the-journey-to-secure-the-software-supply-chain-at-microsoft/) to supply chain security exemplifies this hybrid: central teams provide tooling and standards while product groups maintain responsibility for their supply chains within those standards.
...
Organizations with strong collaboration mechanisms respond faster to supply chain incidents. When the [Log4Shell vulnerability](https://www.cisa.gov/sites/default/files/publications/CSRB-Report-on-Log4-July-11-2022_508.pdf) emerged, organizations with established cross-functional relationships mobilized within hours; those without spent the first day figuring out who should be involved.
