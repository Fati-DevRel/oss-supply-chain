...
|-----|-------------------|---------|
| **MTTR for Critical Vulns** | < 7 days | CISA KEV deadline for federal agencies; represents aggressive but achievable target. Chainguard demonstrates sub-20-hour remediation is achievable for container images.[^chainguard-mttr] |
...
| **SBOM Coverage** | > 90% for critical apps | EU CRA and US executive orders driving toward universal SBOM requirements |
| **Dependency Currency** | > 80% within 2 major versions | Based on ecosystem studies showing risk increases significantly for older versions |
...
!!! tip "Balance 50/50 Leading and Lagging"
    ...
    Only lagging indicators is driving by rearview mirror. Only leading indicators creates false confidence—right activities without confirmed outcomes. Use 50/50 or 60/40 split for executive reporting.
...
- **Regulatory exposure**: Potential fines or penalties for non-compliance
  - Example: GDPR fines[^gdpr-fines] could reach 4% of annual revenue for data breaches
