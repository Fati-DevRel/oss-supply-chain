...
| Cost avoidance | Supply chain incidents average [$4.76M in direct costs](https://www.ibm.com/reports/data-breach) (IBM Cost of a Data Breach, 2023) |
| Regulatory compliance | Regulations increasingly require supply chain security practices (e.g., [EU CRA](https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act) for products with digital elements, [FDA guidance](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/cybersecurity-medical-devices-quality-system-considerations-and-content-premarket-submissions) for medical devices) while frameworks like [NIST SSDF](https://csrc.nist.gov/projects/ssdf) establish best practices |
...
| Policy enforcement | Buy or build | Depends on complexity; [Kyverno](https://kyverno.io/)/[OPA](https://www.openpolicyagent.org/) often sufficient |
| Provenance verification | Open source | [Sigstore](https://www.sigstore.dev/) provides excellent open source tooling |
...
| Dependency updates | Hours per update | [Dependabot](https://github.com/dependabot), [Renovate](https://github.com/renovatebot/renovate) automatic PRs |
