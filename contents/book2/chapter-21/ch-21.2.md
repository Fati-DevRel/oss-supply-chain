...
3. **Prioritization**: Supply chain vulnerabilities are prioritized using the same framework as other vulnerabilities ([CVSS](https://www.first.org/cvss/), [EPSS](https://www.first.org/epss/), [SSVC](https://github.com/CERTCC/SSVC))
...
Tools referenced: [Snyk](https://snyk.io/), [Grype](https://github.com/anchore/grype), [DefectDojo](https://www.defectdojo.com/), [Nucleus](https://nucleussec.com/)
...
2. **Map to supply chain security requirements**: Compare existing capabilities against a comprehensive supply chain security framework (e.g., [SLSA](https://slsa.dev/), [NIST SSDF](https://csrc.nist.gov/projects/ssdf))
