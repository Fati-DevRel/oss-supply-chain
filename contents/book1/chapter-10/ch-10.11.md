...
4. **Repository exposure**: Exfiltrated credentials to public GitHub repositories with the description "Shai-Hulud: The Second Coming"—and cleverly, if no local GitHub credentials existed, the worm would search GitHub for credentials exfiltrated from *other* victims and use those instead
...
[^trust-wallet]: Trust Wallet, "Security Incident Disclosure," December 2025, disclosed via company blog post linking the Chrome extension compromise to the Shai-hulud outbreak.
