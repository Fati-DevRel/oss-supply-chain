---
title: "Container and Image Supply Chains"
description: "Secure container images that aggregate risks from base images, system packages, and build tooling into deployable artifacts."
...
!!! warning "Layered Risk Accumulation"

    A vulnerability in any layer affects all images built upon it. Research consistently finds over **60% of container images** in production contain high or critical vulnerabilities, with the average image containing **30+ high-severity CVEs**.
...
!!! tip "Minimal Base Images"

    Alpine (~7MB) and distroless (~2-20MB) images dramatically reduce attack surface compared to full Ubuntu (~77MB) or Debian (~124MB) images. Fewer packages mean fewer vulnerabilities.
...
[^sysdig-2024]: Sysdig, "2024 Cloud-Native Security and Usage Report," 2024, https://sysdig.com/2024-cloud-native-security-and-usage-report/
