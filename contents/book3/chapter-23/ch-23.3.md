...
[^champion-ratios]: OWASP Security Champions Guidebook, https://owasp.org/www-project-security-champions-guidebook/. Note: BSIMM-14 reports median ratios of 1:100 for security teams and 1:57 for champions; the more aggressive ratios here (1:15 to 1:8) reflect best practices for high-risk environments. Actual ratios vary based on team structure, product risk profile, and organizational security maturity.

Organizations with high-risk products or regulatory requirements may need higher ratios. These ratios align with guidance from the OWASP Security Champions program[^owasp-security-champions] and similar industry initiatives.
...
**Training curriculum for champions** (see OWASP Security Champions Guide[^owasp-security-culture] for additional curriculum guidance):
