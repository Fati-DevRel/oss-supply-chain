...
description: "Supply chain requirements expanded post-EO 14028—the transition to Rev 5 baselines introduced the new Supply Chain Risk Management control family for cloud service providers."
...
!!! info "Supply Chain Requirements Expanded Post-EO 14028"
    ...
    The transition to Rev 5 baselines introduced the new Supply Chain Risk Management (SR) control family, explicitly addressing concerns previously scattered across other control families. For CSPs, understanding these requirements is essential for federal market engagement.
...
!!! tip "Due Diligence Quick-Start Guide"
    NIST SP 1326 "C-SCRM Due Diligence Assessment Quick-Start Guide" (November 2024)[^nist-sp-1326] provides practical implementation guidance for SR-2 and SR-6 requirements, offering assessment procedures and checklists specifically for acquirer due diligence of software suppliers.

[^nist-sp-1326]: NIST, "C-SCRM Due Diligence Assessment Quick-Start Guide (SP 1326)," November 2024, https://csrc.nist.gov/pubs/sp/1326/ipd
...
FedRAMP's **Software Bill of Materials (SBOM)** requirements align with Executive Order 14028 mandates, though the specific implementation has evolved since the EO's May 2021 issuance. Currently, SBOMs are not explicitly required under FedRAMP Rev 5 baselines[^fossa-sbom-guide], but they're becoming increasingly expected and will likely be mandatory under the proposed FedRAMP 20x framework[^fedramp-20x] currently in pilot phase.
