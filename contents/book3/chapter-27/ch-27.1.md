...
- **V2.2** (L2): SBOM is in a machine-readable standard format (SPDX[^spdx], CycloneDX[^cyclonedx])
...
- Scorecard[^scorecard]: OpenSSF tool assessing project security practices. Evaluates open source projects against criteria like branch protection, dependency update tools, and security policy presence—helping organizations make informed adoption decisions per SCVS V5.3.
