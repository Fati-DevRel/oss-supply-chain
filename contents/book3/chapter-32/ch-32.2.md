...
A modern vehicle contains more lines of code than a fighter jet—[over 100 million in premium models](https://spectrum.ieee.org/this-car-runs-on-code), compared to roughly 8 million in an F-35—running on 70 to 150 electronic control units communicating across multiple networks. When [Jeep Cherokees were remotely hacked in 2015](https://www.computerworld.com/article/1628895/chrysler-recalls-14m-vehicles-after-jeep-hack.html), researchers demonstrated they could control steering and brakes through the entertainment system, forcing Chrysler to recall 1.4 million vehicles. The incident marked a turning point: automobiles had become software-defined products, and automotive supply chain security had to encompass code as much as steel.
...
**[IATF 16949](https://www.iatfglobaloversight.org/iatf-169492016/about/)** is the automotive quality management standard, building on ISO 9001 with automotive-specific requirements:
...
**[Automotive SPICE](https://www.automotivespice.com/)** provides a process assessment model for software development, based on the ISO/IEC 330xx series of standards (formerly ISO/IEC 15504):
...
- [ISO/SAE 21434](https://www.iso.org/standard/70918.html) provides cybersecurity engineering standard for road vehicles
...
[OpenSSF Scorecard](https://scorecard.dev/) and [Best Practices Badge](https://www.bestpractices.dev/) provide partial equivalents, but adoption is voluntary and coverage incomplete. A more structured quality framework for critical software infrastructure might draw on automotive models.
...
The [EU CRA](https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act) begins to create software recall equivalents through mandatory security update requirements and incident reporting. This represents movement toward automotive-style accountability.
...
[EU CRA](https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act) represents similar approach for software generally—mandatory requirements with market access implications.
