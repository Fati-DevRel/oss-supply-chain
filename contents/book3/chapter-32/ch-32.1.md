...
In 2012, contaminated injectable steroids from the [New England Compounding Center](https://archive.cdc.gov/www_cdc_gov/hai/outbreaks/meningitis.html) caused a fungal meningitis outbreak that killed 64 people and sickened nearly 800 across 20 states. The tragedy exposed vulnerabilities in pharmaceutical supply chains that allowed unsafe products to reach patients without adequate tracking or verification. The regulatory response—including the [Drug Supply Chain Security Act (DSCSA)](https://www.fda.gov/drugs/drug-supply-chain-integrity/drug-supply-chain-security-act-dscsa) of 2013—created one of the most comprehensive supply chain security frameworks in any industry.
...
The provenance attestation frameworks emerging in software ([SLSA](https://slsa.dev), [Sigstore](https://docs.sigstore.dev)) begin to address this gap, but remain far less comprehensive than pharmaceutical requirements.
...
**[Good Manufacturing Practice](https://www.fda.gov/drugs/pharmaceutical-quality-resources/current-good-manufacturing-practice-cgmp-regulations)** regulations require manufacturers to:
...
Counterfeit pharmaceuticals represent a significant threat—the [WHO estimates](https://www.who.int/news-room/fact-sheets/detail/substandard-and-falsified-medical-products) that up to 10% of medicines in low- and middle-income countries are substandard or falsified, with rates reaching 50% in some regions. The industry has developed sophisticated counterfeit detection approaches.
...
Tools like [GUAC](https://guac.sh) aggregate this information, but comprehensive track and trace for software remains aspirational.
...
- [Package URL (purl)](https://github.com/package-url/purl-spec) and other identifiers serve this role
...
- [EU CRA](https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act) mandates certain supply chain security practices
