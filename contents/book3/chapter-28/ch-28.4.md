...
Section 742.15(b) of the EAR[^ear-742-15] provides a critical exception for **publicly available encryption source code**. This exception permits export of encryption source code that is:
...
GitHub[^github-trade-controls] restricts access to certain features for users in comprehensively sanctioned countries and regions, including Iran, North Korea, Syria, Cuba, Crimea, and (post-2022) Russia and Belarus. Restrictions have included:
