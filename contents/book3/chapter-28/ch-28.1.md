...
- **[MIT License](https://opensource.org/license/mit)**: Permits nearly unrestricted use with attribution
- **[Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0)**: Similar to MIT with additional patent grant provisions
- **BSD Licenses**: Various forms permitting broad use with attribution
- **[ISC License](https://choosealicense.com/licenses/isc/)**: Functionally equivalent to MIT with simpler language
...
- **[GNU General Public License (GPL) v2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) and [v3](https://www.gnu.org/licenses/gpl-3.0.en.html)**: Strong copyleft requiring source distribution for derivative works
- **[GNU Lesser General Public License (LGPL)](https://www.gnu.org/licenses/lgpl-3.0.en.html)**: Weaker copyleft permitting linking without triggering copyleft
- **[Mozilla Public License (MPL) 2.0](https://www.mozilla.org/en-US/MPL/2.0/)**: File-level copyleft affecting only modified files
- **[GNU Affero General Public License (AGPL)](https://www.gnu.org/licenses/agpl-3.0.en.html)**: GPL-like terms extending to network interaction
...
Some projects use the **[Developer Certificate of Origin (DCO)](https://developercertificate.org/)** instead of CLAs. The DCO is a lightweight attestation that:
...
- [`licensee`](https://github.com/licensee/licensee): License detection for repositories
- [`license-checker`](https://www.npmjs.com/package/license-checker): npm package license verification
- [`pip-licenses`](https://pypi.org/project/pip-licenses/): Python package license listing
- [FOSSA](https://fossa.com/), [Snyk](https://snyk.io/), [Black Duck](https://www.synopsys.com/software-integrity/security-testing/software-composition-analysis.html): Commercial license analysis platforms
...
The **[Commons Clause](https://commonsclause.com/)** and similar license modifications add restrictions to otherwise open source licenses:
...
Software with these restrictions isn't considered open source by [Open Source Initiative definitions](https://opensource.org/osd) but appears in repositories alongside open source components. Your SBOM and license inventory should identify these restrictions to prevent compliance violations.
