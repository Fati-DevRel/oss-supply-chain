...
!!! tip "Apache 2.0 Includes Explicit Patent Grant"
    ...
    The Apache License includes an explicit patent grant covering patents that contributors necessarily infringed by their contributions. MIT and BSD licenses lack explicit patent grants, creating greater uncertainty. Prefer Apache 2.0-licensed dependencies when patent exposure is a concern.
