...
**[Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) Patent Grant:**
...
**[GPL v3](https://www.gnu.org/licenses/gpl-3.0.en.html) Patent Provisions:**
...
Check the current definition at [OIN's website](https://www.openinventionnetwork.com/linux-system/) to determine whether specific dependencies receive OIN protection.

**Other Defensive Initiatives:**

- **[Unified Patents](https://www.unifiedpatents.com/)**: Focuses on challenging low-quality patents
- **[LOT Network](https://lotnet.com/)**: Members commit to license patents defensively if they're transferred to assertion entities
- **[Google's Open Patent Non-Assertion Pledge](https://www.google.com/patents/opnpledge/)**: Covers specific Google patents
- **[Red Hat's Patent Promise](https://www.redhat.com/en/about/patent-promise)**: Commits not to assert patents against open source software
...
- **[AV1](https://aomedia.org/)**: Royalty-free video codec alternative to H.264/H.265
- **[Opus](https://opus-codec.org/)**: Royalty-free audio codec
- **[Zstandard](https://github.com/facebook/zstd)**: Royalty-free compression with patent grant
- **[WebM](https://www.webmproject.org/)**: Royalty-free video format
