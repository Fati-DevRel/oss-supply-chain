...
description: "AI democratizes sophisticated attacks—the teenager in a basement can now generate exploit code that previously required years of expertise. This expands the threat landscape."
icon: "lucide/radar"
---
...
!!! warning "Democratization of Sophisticated Attacks"
    AI doesn't just make existing attackers more capable—it creates *new* attackers by lowering barriers to entry. The teenager in a basement can now generate exploit code that previously required years of expertise. This is a quantitative *and* qualitative expansion of the threat landscape.
...
!!! danger "Synthetic Community Members at Scale"
    The xz-utils attack involved human social engineering pressure on a burned-out maintainer. Now imagine that attack with AI: hundreds of "community members" simultaneously pressuring maintainers, each persona individually convincing, all coordinated toward malicious goals. This is not science fiction—the capability exists today.
