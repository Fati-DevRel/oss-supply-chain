...
[Research demonstrates](https://arxiv.org/abs/2402.06664) that AI models can generate functional exploit code, though with limitations. As models improve, the gap between AI capability and human expert capability narrows.
...
- **North Korea (Lazarus Group)**: `npm` supply chain attacks targeting cryptocurrency developers including the ["Contagious Interview" campaign](https://unit42.paloaltonetworks.com/two-campaigns-by-north-korea-bad-actors-target-job-hunters/) (2024), with [hundreds of malicious packages discovered](https://blog.phylum.io/north-korea-still-attacking-developers-via-npm/)
- **China (multiple groups including [Silk Typhoon](https://www.microsoft.com/en-us/security/blog/2025/03/05/silk-typhoon-targeting-it-supply-chain/), TA415)**: Supply chain attacks targeting IT services, semiconductors, and managed service providers
...
- Memory-safe languages eliminating vulnerability classes (see [CISA guidance](https://www.cisa.gov/resources-tools/resources/case-memory-safe-roadmaps))
- Improved tooling for detection and response ([SLSA](https://slsa.dev), [Sigstore](https://sigstore.dev))
- Regulatory pressure driving security investment
- Industry coordination on threats ([OpenSSF](https://openssf.org))
