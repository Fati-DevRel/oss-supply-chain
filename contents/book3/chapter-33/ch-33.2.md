...
Research demonstrates[^ai-exploit-research] that AI models can generate functional exploit code, though with limitations. As models improve, the gap between AI capability and human expert capability narrows.
...
[^ai-exploit-research]: arXiv, "LLMs Can Generate Functional Exploit Code," 2024, https://arxiv.org/abs/2402.06664
