...
description: "Knowledge without action changes nothing—the gap between awareness and action is where good intentions die. Commit to one concrete step today. We rise or fall together."
...
!!! warning "The Tragedy of the Digital Commons"
    Critical open source infrastructure is often maintained by volunteers while billion-dollar companies extract value without contributing. This isn't just unfair—it's a systemic security risk. Every organization benefits from log4j, OpenSSL, and countless other projects. Ask not "what can I take?" but "what can I contribute?"
...
!!! danger "The Knowing-Doing Gap"
    Reading this book gives you knowledge. Only action gives you security. Before you close this chapter, commit to one concrete step: generate your first SBOM, enable Dependabot, or add a SECURITY.md to your project. Small actions taken immediately compound into significant improvement. Deferred actions remain forever deferred.
...
No one organization can solve software supply chain security, but together we can. The progress made since SolarWinds—Sigstore[^sigstore], SLSA[^slsa], expanded SBOM adoption, registry security improvements, regulatory frameworks—resulted from collaboration across organizations, often among competitors.

The Open Source Security Foundation[^openssf] demonstrates what collaboration can achieve. Companies that compete fiercely in the market collaborate on shared security infrastructure. They do so because they recognize that ecosystem security is not a competitive advantage—it's a shared foundation that benefits everyone. A rising tide lifts all boats.

Collaboration takes many forms:

- **Contributing to shared infrastructure**: Sigstore[^sigstore], OpenSSF Scorecard[^scorecard], and similar tools benefit everyone
...
- Run OpenSSF Scorecard[^scorecard] against your project and address one finding
...
- Join an OpenSSF[^openssf] working group or similar community
