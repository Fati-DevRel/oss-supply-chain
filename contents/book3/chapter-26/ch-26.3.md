...
The SSDF is explicitly referenced in OMB M-22-18 and the CISA Secure Software Development Attestation Form.

!!! tip "Map Your Practices to SSDF"

    Organizations attesting to secure development practices are effectively certifying SSDF implementation. Map your existing practices to SSDF practices and tasks, identify gaps requiring remediation before attestation.
