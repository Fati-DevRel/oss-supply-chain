...
The CRA emerged from the EU's broader cybersecurity strategy, responding to the same supply chain security concerns that prompted U.S. Executive Order 14028. However, the European approach differs fundamentally in its mechanism: rather than procurement requirements, the CRA uses product safety regulation, treating insecure software as analogous to unsafe physical products that cannot legally be sold. This approach—backed by significant penalties of [up to €15 million or 2.5% of global annual turnover](https://digital-strategy.ec.europa.eu/en/policies/cra-summary)—ensures uniform application across the entire European market.
...
**Actively exploited vulnerabilities** must be reported to the [European Union Agency for Cybersecurity (ENISA)](https://www.enisa.europa.eu/) within **24 hours** of the manufacturer becoming aware that a vulnerability is being actively exploited. This initial notification must include:
...
The Commission is empowered to adopt delegated acts specifying SBOM format and elements. This creates potential for future harmonization with U.S. [NTIA minimum elements](https://www.ntia.gov/page/software-bill-materials) and international standards like [SPDX](https://spdx.dev) and [CycloneDX](https://cyclonedx.org).
...
**Important products (Class I)** include operating systems, identity management systems, browsers, password managers, VPNs, network management systems, security information and event management (SIEM) tools, boot managers, and others listed in [Annex III](https://www.craact.eu/annex-iii-important-products-with-digital-elements/). These may use self-assessment if conforming to harmonized standards covering all essential requirements; otherwise, third-party assessment is required.
...
Open source foundations have actively prepared for CRA implementation. The [Eclipse Foundation](https://www.eclipse.org), [Apache Software Foundation](https://www.apache.org), [Linux Foundation](https://www.linuxfoundation.org), and others have developed guidance for their communities, including through the [Open Regulatory Compliance Working Group](https://orcwg.org/).
