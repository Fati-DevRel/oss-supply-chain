...
**Actively exploited vulnerabilities** must be reported to the European Union Agency for Cybersecurity (ENISA)[^enisa] within **24 hours** of the manufacturer becoming aware that a vulnerability is being actively exploited.

!!! warning "24-Hour Notification Challenge"

    Many organizations currently take days or weeks to confirm exploitation status. The CRA's timeline demands rapid internal escalation procedures, pre-established ENISA communication channels, and potentially 24/7 security operations capability.
