...
Australia has pursued supply chain security primarily through critical infrastructure protection and government procurement. The [**Security of Critical Infrastructure Act 2018**](https://www.cisc.gov.au/legislation-regulation-and-compliance/soci-act-2018), as amended, establishes cybersecurity obligations for designated critical infrastructure sectors, including requirements for supply chain risk management.
...
For software specifically, Japan relies primarily on industry guidance and international standards. The [Ministry of Economy, Trade and Industry (METI)](https://www.meti.go.jp/english/policy/safety_security/cybersecurity/index.html) has published the **Cyber/Physical Security Framework (CPSF)**, aligned with NIST frameworks. Japan participates actively in international standardization efforts and has indicated intent to harmonize with emerging international approaches.
...
The [EU-US Trade and Technology Council (TTC)](https://commission.europa.eu/strategy-and-policy/priorities-2019-2024/stronger-europe-world/eu-us-trade-and-technology-council_en) has identified cybersecurity and supply chain security as priority areas for coordination. Working groups have addressed:
...
- [**ISO/IEC 5230**](https://www.iso.org/standard/81039.html): OpenChain specification for open source license compliance (provides model for supply chain attestation)
- [**ISO/IEC 5962**](https://www.iso.org/standard/81870.html): SPDX specification for software bill of materials (SBOM format standard)
...
The [IEEE Standards Association](https://standards.ieee.org) develops technical standards with significant supply chain security implications:

- [**IEEE 2883-2022**](https://standards.ieee.org/ieee/2883/10277/): Standard for sanitizing storage (relevant to supply chain data protection)
...
- [**OASIS CSAF**](https://docs.oasis-open.org/csaf/csaf/v2.0/os/csaf-v2.0-os.html): Common Security Advisory Framework for vulnerability communication
- [**OASIS OpenC2**](https://openc2.org/): Open Command and Control for automated response
- [**CycloneDX**](https://cyclonedx.org/): OWASP-originated SBOM format, now standardized as ECMA-424 with ISO consideration ongoing
...
1. Implementing secure development practices aligned with [NIST SSDF](https://csrc.nist.gov/pubs/sp/800/218/final) (satisfies U.S. attestation requirements and substantially addresses CRA essential requirements)
2. Generating SBOMs in standardized formats ([SPDX](https://spdx.dev) or [CycloneDX](https://cyclonedx.org)) meeting both NTIA minimum elements and CRA requirements
