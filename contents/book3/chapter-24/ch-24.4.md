...
|----------|-------|----------|
| **[GitHub Security Lab](https://securitylab.github.com/)** | CodeQL tooling + [Secure Open Source Fund](https://resources.github.com/github-secure-open-source-fund/) | GitHub-hosted projects; maintainer grants available |
| **[Huntr](https://huntr.com/)** | AI/ML-focused bug bounties | AI/ML open source projects |
| **[HackerOne](https://www.hackerone.com/resources/hackerone/internet-bug-bounty)** | Internet Bug Bounty for critical OSS | Major infrastructure projects (Curl, Django, Node.js, Ruby, OpenSSL) |
| **[Open Bug Bounty](https://www.openbugbounty.org/)** | Free, community-driven | Projects with no budget |
...
- [CodeQL](https://codeql.github.com/) queries for finding vulnerability patterns
- [Secure Open Source Fund](https://resources.github.com/github-secure-open-source-fund/) providing $10,000 grants to maintainers
...
|--------------|-------------------|
| [Google Project Zero](https://projectzero.google/vulnerability-disclosure-faq.html) | 90 days (reduced for active exploitation) |
| [CERT/CC](https://certcc.github.io/certcc_disclosure_policy/) | 45 days |
