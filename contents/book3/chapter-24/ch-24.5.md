...
description: "Burnout is a security vulnerability—attackers specifically target maintainer exhaustion. Your wellbeing isn't separate from project security; it's foundational to it."
icon: "lucide/heart"
---
...
!!! warning "Burnout Is a Security Vulnerability"
    ...
    The XZ Utils incident showed attackers specifically target maintainer burnout. A burned-out maintainer makes mistakes, accepts help uncritically, and may miss social engineering attempts. Your wellbeing isn't separate from project security—it's foundational to it.
...
Maintainer burnout is endemic in open source. The consequences extend beyond personal wellbeing to measurable security outcomes: Sonatype's 2024 State of the Software Supply Chain report found that some critical vulnerabilities took over **500 days to remediate** in 2024[^sonatype-remediation]—a timeline that reflects severe maintainer capacity constraints and burnout across the ecosystem.

[^sonatype-remediation]: Sonatype, "2024 State of the Software Supply Chain Report," October 2024, https://www.sonatype.com/state-of-the-software-supply-chain/introduction
