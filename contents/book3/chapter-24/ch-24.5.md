...
According to the [2021 Tidelift survey](https://blog.tidelift.com/finding-1-about-half-of-maintainers-get-paid-nothing-for-their-work), 46% of maintainers are unpaid, yet users and corporations often expect immediate responses and continuous support. Sustainable practices are essential:
...
|----------|-------------|
| **[OSMI (Open Sourcing Mental Illness)](https://osmihelp.org/)** | Mental health resources for tech community |
| **Professional help** | Therapists, counselors—maintaining software doesn't mean you can't need support |
| **Crisis resources** | [International crisis lines](https://www.iasp.info/resources/Crisis_Centres/) for immediate needs |
...
| **[Open Source Guides](https://opensource.guide/)** | Best practices including maintainer health |
