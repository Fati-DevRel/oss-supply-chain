...
- **OSPS Baseline Scanner**[^osps-baseline]: Checks projects against OpenSSF's [OSPS Baseline][osps-baseline-site]—a comprehensive set of security requirements covering access control, build/release practices, vulnerability management, and more

The OSPS Baseline defines specific, verifiable security controls organized by maturity level (1-3). Running the Baseline Scanner helps identify gaps and provides a roadmap for security improvements aligned with industry frameworks like SLSA, NIST SSDF, and the EU Cyber Resilience Act.
