---
title: "Responding to Vulnerability Reports"
description: "Prepare before reports arrive—having a clear process transforms an overwhelming situation into a manageable series of steps from receipt through disclosure."
icon: "lucide/message-square-warning"
---

# 24.2 Responding to Vulnerability Reports

!!! warning "Prepare Before Reports Arrive"

    Most maintainers receive vulnerability reports rarely, which means they're often unprepared when one arrives. Having a clear process in place transforms what could be an overwhelming situation into a manageable series of steps.
...
|---------|--------------|------------|----------|
| **GitHub Security Advisories**[^github-security-advisories] | Minimal | Integrated with GitHub workflow | GitHub-hosted projects |
...
!!! tip "Use CVSS for Consistent Severity"

    Critical (9.0-10.0): Drop everything, fix ASAP. High (7.0-8.9): Prioritize, fix within 1-2 weeks. Medium (4.0-6.9): Plan fix, can follow normal release cycle. Low (0.1-3.9): Address when convenient.

Use CVSS (Common Vulnerability Scoring System)[^cvss] for consistent severity assessment:
...
GitHub is a CVE Numbering Authority (CNA)[^github-cna] and can assign CVEs for projects hosted there:
...
1. Go to cveform.mitre.org[^mitre-cve]
...
| Channel | When to Use |
|---------|-------------|
| GitHub Security Advisory[^github-dependabot-alerts] | Always; creates Dependabot alerts |
...
- Post to relevant security mailing lists (oss-security[^oss-security])
...
[^github-security-advisories]: GitHub, "About Repository Security Advisories," https://docs.github.com/en/code-security/security-advisories

[^cvss]: FIRST, "Common Vulnerability Scoring System," https://www.first.org/cvss/

[^github-cna]: GitHub, "About Repository Security Advisories," https://docs.github.com/en/code-security/security-advisories/working-with-repository-security-advisories/about-repository-security-advisories

[^mitre-cve]: MITRE, "CVE Request Form," https://cveform.mitre.org/

[^github-dependabot-alerts]: GitHub, "About Dependabot Alerts," https://docs.github.com/en/code-security/dependabot/dependabot-alerts/about-dependabot-alerts

[^oss-security]: Openwall, "oss-security Mailing List," https://www.openwall.com/lists/oss-security/
