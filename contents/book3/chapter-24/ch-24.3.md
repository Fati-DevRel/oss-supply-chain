...
2. **Document sensitive files/directories**: Create a [CODEOWNERS](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-code-owners) file that requires additional review
...
4. **Automate detection**: Use tools like [GitHub Actions Labeler](https://github.com/actions/labeler) to flag PRs touching sensitive areas
