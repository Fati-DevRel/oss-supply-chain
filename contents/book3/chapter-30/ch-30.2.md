...
These programs have paid over $1 million for open source vulnerabilities[^ibb-payments]. However, bounty levels are typically lower than corporate programs, limiting researcher interest. As discussed in Chapter 15 on security testing, bug bounties complement but don't replace systematic security practices.
...
Some projects and organizations offer **paid support** tiers that fund security work. The evidence for this model's effectiveness is compelling: Sonatype's 2024 State of the Software Supply Chain report[^sonatype-paid-support] found that projects with paid support resolve vulnerabilities **45% faster** than unfunded projects, have **half as many security issues** overall, and are **three times more likely** to maintain comprehensive security policies. These findings suggest that commercial sustainability and security are not merely correlated but causally linked—funding enables the sustained attention security requires.

[^sonatype-paid-support]: Sonatype, "2024 State of the Software Supply Chain Report," October 2024, https://www.sonatype.com/state-of-the-software-supply-chain/introduction
...
[^ibb-payments]: HackerOne, "Supply Chain Bounty Program," https://docs.hackerone.com/en/articles/8496298-internet-bug-bounty (formerly the Internet Bug Bounty). The program has awarded over $1 million for thousands of valid vulnerabilities in open source software.
