...
**Scale**: The volume of vulnerabilities has grown dramatically. According to [CVE Program metrics](https://www.cve.org/Media/News/item/news/2025/01/01/CVE-Program-2024-In-Review), over 40,000 CVEs were published in 2024—a 38% increase from 28,818 in 2023—averaging 108 CVEs daily. This marks the seventh consecutive year of record-high CVE publications. Processing this volume with quality and timeliness strains program resources.
...
The impact has been dramatic. In 2023, the Linux kernel received 290 CVE assignments. In 2024—the first full year as a CNA—that number exploded to [3,529 CVEs](https://www.cve.org/Media/News/item/news/2025/01/01/CVE-Program-2024-In-Review), a more than 12-fold increase. By mid-2025, the kernel had already accumulated over 5,530 CVEs, maintaining a rate of approximately 8-9 new CVE assignments per day. To put this in perspective: the kernel now generates more CVEs in two weeks than it did in all of 2020.
...
[OSV.dev](https://osv.dev) aggregates vulnerabilities from participating databases, providing a unified API for querying vulnerabilities across ecosystems:
...
[freebsd-osv]: https://www.freebsd.org/status/report-2024-10-2024-12/foundation-security/