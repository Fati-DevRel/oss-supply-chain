...
!!! example "Alpha-Omega Funding Impact"
    In 2024, Alpha-Omega distributed nearly $6 million in grants to critical open source projects. This funding enabled the Python Software Foundation to hire dedicated security staff, Ruby Central to receive comprehensive security audits, and the FreeBSD Foundation to modernize security infrastructure.
...
Alpha-Omega is funded by major technology companies including Amazon Web Services (AWS), Google, and Microsoft. According to the Alpha-Omega 2024 Annual Report[^alpha-omega-2024-report], the program distributed nearly $6 million in grants in 2024 to improve security in critical open source projects, directly enabling security teams at 10 major organizations:

- Python Software Foundation
- OpenJS Foundation (Node.js and JavaScript ecosystem)
- Ruby Central (RubyGems)
- FreeBSD Foundation
- Rust Foundation
- Eclipse Foundation
- Apache Software Foundation
- ISRG (Let's Encrypt, Prossimo)
- Homebrew
- Linux kernel (via the Linux Foundation)

This funding enabled security improvements that would be impossible for volunteer-driven projects, including dedicated security positions, comprehensive audits, infrastructure hardening, and sustainable security cultures. The report documents tangible outcomes including the deployment of trusted publishing, Sigstore integration, and MFA enforcement across multiple ecosystems.
...
[^alpha-omega-2024]: OpenSSF, "Alpha-Omega 2024 Annual Report," January 2025, https://openssf.org/blog/2025/01/29/alpha-omega-2024-annual-report/
